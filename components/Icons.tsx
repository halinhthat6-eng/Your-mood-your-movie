...
export const MvIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7 10.5 9.5 8 12 10.5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 10.5 14.5 8 17 10.5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.5 14.5 12 17 14.5 14.5" />
  </svg>
);
